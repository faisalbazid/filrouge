...
$type_ann=$_POST['selecttype_ann'];
$date=$_POST['date'];
$detail_ann=$_POST['detail_ann'];
$code_imo=mt_rand(100000000, 999999999);


 
  
  
  $query=mysqli_query($con,"INSERT INTO `annonce`(`titre_ann`,`type_ann`,`date`,`detail_ann`,`id_per`) VALUES ('$titre_ann','$type_ann','$date','$detail_ann','$id_per')");
...
$titre_ann=$_POST['titre_ann'];
$id_per=$_SESSION['s_id_per'];
$code_imo=$_SESSION['s_id_per'];

$query=mysqli_query($con,"INSERT INTO `immobilier`(`superficie`,`prix`,`adress`,`type_imo`,`image1`,`image2`,`image3`) VALUES ('$superficie','$prix','$adress','$type_imo','$image1','$image2','$image3')");
  } if ($query) {
//   $query2=mysqli_query($con,"INSERT INTO `annonce`(`titre_ann`) VALUES ('$titre_ann')");
    echo '<script>alert("Property detail has been added.")</script>';
// echo "<script>window.location.href ='add-property.php'</script>";
  } 
  else
